...
## What was good
Let's say vibe coding is when you do not write code and do not care about code quality at all. 
Let's say AI assisted coding is when you read (and understand!) all the code. 
